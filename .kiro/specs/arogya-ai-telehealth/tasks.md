...
- [ ] 6. Initialize FastAPI backend project
  - [ ] 6.1 Create FastAPI project structure
  ...
  - [ ] 6.3 Implement database client module
...
- [ ] 7. Implement WebSocket connection manager
...
- [ ] 8. Build STT pipeline with Hinglish support
  - [ ] 8.1 Implement ASR with fallback logic
  ...
  - [ ] 8.2 Implement language-specific configuration
  ...
  - [ ] 8.3 Integrate translation service
  ...
  - [ ] 8.4 Integrate Community Lexicon lookup
  ...
  - [ ] 8.5 Create process_audio_stream function
...
- [ ] 9. Implement SOAP note generation with Compassion Reflex
  - [ ] 9.1 Create summarizer module
    - Create summarizer.py with generate_notes_with_empathy function
    - _Requirements: 6.1, 7.1_
  - [ ] 9.2 Implement SOAP note generation (Step 1)
  ...
  - [ ] 9.3 Implement Compassion Reflex de-stigmatization (Step 2)
...
- [ ] 10. Create FastAPI endpoints
  - [ ] 10.1 Implement WebSocket endpoint for audio streaming
  ...
  - [ ] 10.2 Implement SOAP note generation endpoint
  ...
  - [ ] 10.3 Implement Community Lexicon endpoint
...
- [ ] 11. Build VideoCallRoom component
  - [ ] 11.1 Implement WebRTC video/audio connection
  ...
  - [ ] 11.2 Implement audio capture and streaming
  ...
  - [ ] 11.3 Implement live caption display
...
- [ ] 12. Build SoapNoteReview component
  - [ ] 12.1 Fetch and display SOAP note
  ...
  - [ ] 12.2 Implement Compassion Reflex UI
  ...
  - [ ] 12.3 Implement Community Lexicon contribution UI
    ...
    - _Requirements: 5.1_
  - [ ] 12.4 Implement note approval and save
